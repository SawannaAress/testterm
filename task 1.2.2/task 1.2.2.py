...
Pk = multP(Pn, n)
print('')
print('если betta - для шкалы К - результат не меняется, т.к. расчеты идут относительно dt, которая не зависит от выбора начала.')
if tn<=0:
    print('Результат не имеет смысла для К, т.к. в реальной системе t [К]>0')
print('')
lastkey()